...
function renderVideos() {
  document.getElementById("primary-list").innerHTML = "";
  document.getElementById("secondary-list").innerHTML = "";
  ...
  videos.forEach((video, index) => {
    ...
    if (video.category === "primary") {
      document.getElementById("primary-list").appendChild(card);
    } else if (video.category === "secondary") {
      document.getElementById("secondary-list").appendChild(card);
    } else {
      document.getElementById("misc-list").appendChild(card);
    }
  });
}
...
addBtn.addEventListener("click", () => {
  ...
  if (id) {
    const videos = getVideos();
    videos.push({ id, watched: false, category });
    saveVideos(videos);
    renderVideos();
    input.value = "";
  } else {
